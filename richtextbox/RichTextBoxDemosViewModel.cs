   ...
   public class RichTextBoxDemosViewModel : DemoBrowserViewModel
    ...
    public class RichTextBoxProductDemos : ProductDemo
    {
        ...
        public RichTextBoxProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "DocumentEditor", GroupName = "SHOWCASE", Title = "Document Editor", Description = "This sample illustrates document editor using SfRichTextBoxAdv control that is similar to Microsoft Word with Ribbon options.", DemoViewType = typeof(syncfusion.documenteditor.wpf.DocumentEditorDemo), ThemeMode = ThemeMode.Inherit, DemoLauchMode = DemoLauchMode.Window, Tag = Tag.None });
